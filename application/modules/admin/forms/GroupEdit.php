 ...
 * @copyright  Copyright (c) 2011-2012 Rexmac, LLC (http://rexmac.com/)
 * @author     Rex McConnell <rex@rexmac.com>
 * @todo Combine with group creation form
 */
class Admin_Form_GroupEdit extends \Rexmac\Zyndax\Form\Form {

  /**
   * Initialization
   *
   * Initialize "edit group" form fields with validators and decorators.
   *
   * @return void
   */
  public function init() {
    $this->setName('group_edit_form');
    $this->setMethod('post');
