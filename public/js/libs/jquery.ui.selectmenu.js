...
$.widget("ui.selectmenu", {
	...
	_create: function() {
		...
		// menu icon
    this.selectmenuButton = $('<span class="'+ this.widgetBaseClass +'-button ui-button-icon-only ui-corner-right"></span>')
      .prependTo(this.newelement); // rex

		this.selectmenuIcon = $( '<span class="' + this.widgetBaseClass + '-icon ui-icon"></span>' )
			//.prependTo( this.newelement );
			.prependTo( this.selectmenuButton ); // rex
		...
		if (!o.width) {
			...
			o.width = this.element.outerWidth() + 24;
		}
	...
	destroy: function() {
		...
		//this.newelementWrap.remove(); // rex
		this.newelement.remove(); // rex
	...
	_refreshPosition: function() {
		...
		if ( o.style == "popup" && !o.positionOptions.offset ) {
			var selected = this._selectedOptionLi();
			_offset = "0 " + ( this.list.offset().top  - selected.offset().top - ( this.newelement.outerHeight() + selected.outerHeight() ) / 2);
		}
