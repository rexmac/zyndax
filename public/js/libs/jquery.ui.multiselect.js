...
$.widget("ech.multiselect", {
	...
	_create: function(){
		var el = this.element.hide(),
		    id = (this.id = el.attr('id') || multiselectID++),
		    o  = this.options;
		...
		var
			button = (this.button = $('<button type="button"><span class="ui-multiselect-button-icon ui-corner-right"><span class="ui-icon ui-icon-triangle-2-n-s"></span></span></button>'))
			...
			buttonlabel = (this.buttonlabel = $('<span id="' + this.id + '_button_label"></span>'))
	...
	update: function(){
		...
		$('#' + this.id + '_button_label').html(value);
		return value;
	},
